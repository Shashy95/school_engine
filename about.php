...
<html lang="en">
  <head>
   <title>School Search Engine &mdash;<?php echo $language["about"]; ?></title>
    <meta charset="utf-8">
  ...
  <div class="site-wrap">
            ...
            <div class="col-4 col-md-4 col-lg-8">
              <nav class="site-navigation text-left text-md-left" role="navigation">
                ...
                <ul class="site-menu js-clone-nav d-none d-lg-block">
                  ...
                  <li class="active"><a href="about.php"><?php echo $language["about"]; ?></a></li>
    ...
    <span class="language" style="margin-left:10px;">
          <img class="img-fluid" width="27px;" src="images/<?php echo $lang?>.png" ></span>
                  ...
                  <option value="about.php?lang=en"<?php if($lang == 'en'){echo "selected"; } ?>>EN</option>
                  <option value="about.php?lang=sw"<?php if($lang == 'sw'){echo "selected"; } ?>>SW</option>
                  </select>
  ...
  <div class="site-blocks-cover inner-page-cover overlay" style="background-image: url(images/hero_bg_2.jpg);" data-aos="fade" data-stellar-background-ratio="1.0">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          <div class="col-md-10">
            <h1 class="mb-2"><?php echo $language["about"]; ?></h1>
            <div><a href="index.php"><?php echo $language["index"]; ?></a> <span class="mx-2 text-white">&bullet;</span> <strong class="text-white"><?php echo $language["about"]; ?></strong></div>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-5 ml-auto"  data-aos="fade-up" data-aos-delay="200">
            <div class="site-section-title mb-3">
              <h2><?php echo $language["company"]; ?></h2>
            </div>
