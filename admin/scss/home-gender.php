         ...
         <div class="col-xl-10 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Number of Schools Based On Different Gender</h6>
                  <div class="dropdown no-arrow">
                    <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                     <div class="dropdown-header">Graphs based on:</div>
                      <a class="dropdown-item " href="home.php">Level</a>
                      <a class="dropdown-item" href="home-category.php">Category</a>
                      <a class="dropdown-item  " href="home-type.php">Type</a>
                      <a class="dropdown-item" href="home-region.php">Region</a>
                      <a class="dropdown-item active" href="home-gender.php">Gender</a>
                      <a class="dropdown-item" href="home-combination.php">Combination</a>
                    </div>
                  </div>
                </div>
                <!-- Card Body -->
...
require_once("fusioncharts.php");
  ...
  $hostdb = "localhost:3306";  // MySQl host
   $userdb = "adilischoolac_search";  // MySQL username
   $passdb = "searchschool";  // MySQL password
   $namedb = "adilischoolac_school";  // MySQL database name
   ...
   if ($dbhandle->connect_error) {
      exit("There was an error with your connection: ".$dbhandle->connect_error);
           ...
           $strQuery = " SELECT en_gender,COUNT(en_gender)  FROM schools group by en_gender ORDER BY count(en_gender) desc ";
  ...
  if ($result) {
      ...
      while($row = mysqli_fetch_array($result)) {
              ...
              $columnChart = new FusionCharts("column3D", "myFirstChart" , "100%", "100%", "myAreaChart", "json", $jsonEncodedData);
              $columnChart->render();
             $dbhandle->close();
           }
