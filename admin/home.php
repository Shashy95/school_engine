            ...
            <div class="col-xl-8 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Number of Schools Based On Different Levels</h6>
                  <div class="dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                      ...
                      <a class="dropdown-item active" href="home.php">Level</a>
...
?>
     <?php
           ...
           $strQuery = " SELECT en_level,COUNT(en_level)  FROM schools group by en_level ORDER BY count(en_level) desc ";
