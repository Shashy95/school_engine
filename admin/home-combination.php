         ...
         <div class="col-xl-10 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Number of Schools Based On Different Combination</h6>
                  <div class="dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                     <div class="dropdown-header">Graphs based on:</div>
                      ...
                      <a class="dropdown-item active" href="home-combination.php">Combination</a>
                    </div>
                  </div>
                </div>
                <!-- Card Body -->
...
require_once("fusioncharts.php");
   ...
   if ($dbhandle->connect_error) {
      exit("There was an error with your connection: ".$dbhandle->connect_error);
         ...
         $strQuery = "SELECT combination  FROM schools where combination NOT IN ('') GROUP BY combination  ";
...
$jsonEncodedData = json_encode($arrData);
              ...
              $columnChart = new FusionCharts("pie3D", "myFirstChart" , "100%", "100%","myAreaChart", "json", $jsonEncodedData);
              $columnChart->render();
              $dbhandle->close();
           }
