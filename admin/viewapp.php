    ...
    <div id="content-wrapper" class="d-flex flex-column">
     ...
     <div class="select-wrap">
          <img class="img-fluid" width="27px;" src="img/<?php echo $lang?>.png" >
                  ...
                  <option value="viewapp.php?lang=en"<?php if($lang == 'en'){echo "selected"; } ?>>EN</option>
                  <option value="viewapp.php?lang=sw"<?php if($lang == 'sw'){echo "selected"; } ?>>SW</option>
                  </select>
</div>
                </li>
 ...
 if(ISSET($_POST['delete'])){
    if(ISSET($_POST['check'])){
      ...
      for($i=0; $i < count($checked); $i++){
        $id = $checked[$i];
        $sql=mysqli_query($connection, "DELETE FROM form WHERE id=$id");
      }
...
$msg= '<div class="alert alert-success">Success! Your application has been deleted successfully.
 <a href="" class="closebtn" data-dismiss="alert" aria-label="close">&times;</a>
            </div>';
        }
...
?>
     <span class="msg"> <?php echo $msg;?></span>  
         ...
         $view_application="select * from form where ".$lang."_gender NOT IN ('')";//select query for viewing users.
           $run=mysqli_query($connection,$view_application);//here run the sql query.
//here run the sql query.
        ...
        ?>
            ...
            <td><?php echo $row[$lang.'_relation']; ?></td>
