         ...
         <div class="col-xl-10 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Number of Schools Based On Different Type</h6>
                  <div class="dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                     <div class="dropdown-header">Graphs based on:</div>
                      ...
                      <a class="dropdown-item  active" href="home-type.php">Type</a>
  ...
  $hostdb = "localhost";  // MySQl host
   ...
   if ($dbhandle->connect_error) {
      exit("There was an error with your connection: ".$dbhandle->connect_error);
           ...
           $strQuery = " SELECT en_type,COUNT(en_type)  FROM schools group by en_type ORDER BY count(en_type) desc ";
