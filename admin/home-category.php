         ...
         <div class="col-xl-10 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Number of Schools Based On Different Categories</h6>
                  <div class="dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                     <div class="dropdown-header">Graphs based on:</div>
                      ...
                      <a class="dropdown-item active" href="home-category.php">Category</a>
                      <a class="dropdown-item" href="home-type.php">Type</a>
                      <a class="dropdown-item" href="home-region.php">Region</a>
                      <a class="dropdown-item" href="home-gender.php">Gender</a>
...
?>
     <?php
           ...
           $strQuery = " SELECT en_category,COUNT(en_category)  FROM schools group by en_category ORDER BY count(en_category) desc ";
  ...
  if ($result) {
      ...
      while($row = mysqli_fetch_array($result)) {
                 ...
                 array_push($arrData["data"], array(
                    "label" =>$row["en_category"] ,
                    "value" =>  $row["COUNT(en_category)"]
