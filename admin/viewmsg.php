    ...
    <div id="content-wrapper" class="d-flex flex-column">
     ...
     <div class="select-wrap">
          <img class="img-fluid" width="27px;" src="img/<?php echo $lang?>.png" >
                  ...
                  <option value="viewmsg.php?lang=en"<?php if($lang == 'en'){echo "selected"; } ?>>EN</option>
                  <option value="viewmsg.php?lang=sw"<?php if($lang == 'sw'){echo "selected"; } ?>>SW</option>
                  </select>
</div>
                </li>
 ...
 if(ISSET($_POST['delete'])){
    if(ISSET($_POST['check'])){
      ...
      for($i=0; $i < count($checked); $i++){
        $id = $checked[$i];
        $sql=mysqli_query($connection, "DELETE FROM contact WHERE id=$id");
      }
...
$msg= '<div class="alert alert-success">Success! Your message has been deleted successfully.
 <a href="" class="closebtn" data-dismiss="alert" aria-label="close">&times;</a>
            </div>';
        }
...
?>
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">View Messages</h6>
            </div>
            <div class="card-body">
            ...
            <th><?php echo $language["fullname"]; ?></th>
        ...
        $view_msg="select * from contact where ".$lang."_message NOT IN ('')";//select query for viewing users.
        $run=mysqli_query($connection,$view_msg);//here run the sql query.
//here run the sql query.
        ...
        ?>
           ...
           <td><?php echo $row['fullname'];  ?></td>
            ...
            <td><?php echo $row[$lang.'_message']; ?></td>
