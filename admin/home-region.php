         ...
         <div class="col-xl-10 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Number of Schools Based On Different Region</h6>
                  <div class="dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                     <div class="dropdown-header">Graphs based on:</div>
                      ...
                      <a class="dropdown-item  active" href="home-region.php">Region</a>
...
require_once("fusioncharts.php");
   ...
   if ($dbhandle->connect_error) {
      exit("There was an error with your connection: ".$dbhandle->connect_error);
           ...
           $strQuery = "SELECT  region, COUNT(region) FROM schools GROUP BY region order by COUNT(region) desc ";
